...
**213 tools across 20 on-demand toolsets.** Schematic capture, PCB layout and
...
**Context economy is a feature.** Exposing all 213 tools to an LLM costs roughly 25K
