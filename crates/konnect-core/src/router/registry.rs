...
pub static ALL_TOOLSETS: &[ToolsetMeta] = &[
    ...
    ToolsetMeta {
        name: "pcb_components",
        description: "Place, move, rotate, flip, align, duplicate and repair PCB footprints",
        category: "pcb",
        tool_count: 14,
    },
    ToolsetMeta {
        name: "pcb_inspection",
        description: "Inspect PCB footprints, pads and placed-footprint graphics; render a board preview",
        category: "pcb",
        tool_count: 7,
    },
    ToolsetMeta {
...
pub fn tools_for(name: &str) -> Option<Vec<ToolDef>> {
    ...
    match name {
        ...
        "pcb_inspection" => Some(pcb_components::inspection_tools()),
